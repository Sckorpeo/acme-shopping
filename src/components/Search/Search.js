    ...
    return (
        <form className='search-form' onSubmit={handleSubmit}>
            <div className="search-wrapper">
                ...
                />
                <input ref={searchBar} className="search" placeholder="Search" type="text" onKeyUp={keyUpHandler} value={searchKey} onChange={handleChange}/>
            ...
            <nav className='search-result-wrapper'>
                {searchResult && searchResult.length > 0 && (
                    <ul className='neumorphism search-result'>
